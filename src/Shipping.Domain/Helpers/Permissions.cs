...
public static class Permissions
{
    ...
    //This uses reflection to get all const string fields in this class at runtime.
    //instead of manually listing all permissions when seeding them into the database
